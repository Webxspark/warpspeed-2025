                    ...
                    <DialogHeader className={'mx-4 mt-4 flex flex-row justify-between items-center'}>
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M10.9 2.1l9.9 1.34c1 .14 1.67.93 1.5 1.93l-1.57 9.78c-.15.98-1.05 1.63-2.04 1.48l-3.5-.5"></path>
                                <path d="M8.9 2.1L5.4 2.6c-1 .14-1.67.93-1.5 1.93L5.8 19.3c.15.98 1.05 1.63 2.04 1.48l3.5-.5"></path>
                            ...
                            <div className="w-full h-full relative">
                                {Object.entries(remoteParticipants).map(([id, p]: [string, any]) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-2 left-2 bg-black bg-opacity-50 px-3 py-1 rounded text-white">
                                ...
                                <div className="absolute bottom-4 right-4 w-40 h-24 bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-700">
                                    <video
                                        id="local-video"
                                        autoPlay
                                        playsInline
                                        ...
                                        className="w-full h-full object-cover"
                                    />
                                    <div className="absolute bottom-1 left-1 bg-black bg-opacity-50 px-2 py-0.5 rounded text-xs text-white">
                                        You
                                    </div>
                                </div>
                            </div>
                        ) : (
                            <div className="w-full flex items-center justify-center h-full bg-gray-800 rounded-lg" style={{minHeight: "32rem"}}>
                                {!loading ? (
